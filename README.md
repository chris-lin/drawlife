...
~~~sh
git clone git@github.com:nko3/taiwan-up-up.git
~~~
...
~~~sh
npm install -g jitsu
jitsu login --username nko3-taiwan-up-up --password SlyXDGVl5+HyZ89U
jitsu deploy
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/taiwan-up-up" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
...
[2]: https://github.com/organizations/nko3/teams/280742
[3]: https://github.com/nko3/taiwan-up-up
